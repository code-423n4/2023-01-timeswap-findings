...
# 2: For Operations that will not overflow, you could use unchecked

Optimization details

### Context:

In some operations that will not overflow in the code, Unchecked is used but in many other operations it is missing.
...
https://github.com/code-423n4/2023-01-timeswap/blob/ef4c84fb8535aad8abd6b67cc45d994337ec4514/packages/v2-library/src/StrikeConversion.sol#L46 
...
For Operations that will not overflow, it is recommended to use unchecked to save gas.
