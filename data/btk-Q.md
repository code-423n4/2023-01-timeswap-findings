...
| [L-05] | Constants in comparisons should appear on the left side                            | All Contracts |
| [L-06] | Add a timelock to critical functions                                               | 1             |
| [L-07] | `Address(0)` checks                                                                | 2             |
...
| [NC-03] | Include `@return` parameters in NatSpec comments                                          | All Contracts |
| [NC-04] | Contracts should have full test coverage                                                  | All Contracts |
| [NC-05] | Function writing does not comply with the `Solidity Style Guide`                          | All Contracts |
| [NC-06] | Solidity compiler optimizations can be problematic                                        | 3             |
| [NC-07] | Lines are too long                                                                        | 30            |
| [NC-08] | NatSpec comments should be increased in contracts                                         | All Contracts |
| [NC-09] | Generate perfect code headers every time                                                  | All Contracts |
| [NC-10] | For functions, follow Solidity standard naming conventions                                | All Contracts |
| [NC-11] | Use a more recent version of solidity                                                     | All Contracts |
| [NC-12] | Assembly Codes Specific – Should Have Comments                                            | 5             |
| [NC-13] | Events that mark critical parameter changes should contain both the old and the new value | 1             |
| [NC-14] | Consider using `delete` rather than assigning zero to clear values                        | 10            |
| [NC-15] | Add NatSpec Mapping comment                                                               | 10            |
| [NC-16] | Using vulnerable dependency of OpenZeppelin                                               | 2             |
| [NC-17] | Constants should be defined rather than using magic numbers                               | 18            |
...
## [L-06] Add a timelock to critical functions
...
## [NC-04] Contracts should have full test coverage
...
## [NC-08] NatSpec comments should be increased in contracts   
...
## [NC-10] For functions, follow Solidity standard naming conventions 
...
## [NC-16] Using vulnerable dependency of OpenZeppelin 
...
## [NC-17] Constants should be defined rather than using magic numbers 
